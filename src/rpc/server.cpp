...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop SafeDeal Coin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "SafeDeal Coin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SafeDeal features */
        {"safedeal", "listmasternodes", &listmasternodes, true, true, false},
        {"safedeal", "getmasternodecount", &getmasternodecount, true, true, false},
        {"safedeal", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"safedeal", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"safedeal", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"safedeal", "masternodecurrent", &masternodecurrent, true, true, false},
        {"safedeal", "masternodedebug", &masternodedebug, true, true, false},
        {"safedeal", "startmasternode", &startmasternode, true, true, false},
        {"safedeal", "createmasternodekey", &createmasternodekey, true, true, false},
        {"safedeal", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"safedeal", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"safedeal", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"safedeal", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"safedeal", "getmasternodescores", &getmasternodescores, true, true, false},
        {"safedeal", "preparebudget", &preparebudget, true, true, false},
        {"safedeal", "submitbudget", &submitbudget, true, true, false},
        {"safedeal", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"safedeal", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"safedeal", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"safedeal", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"safedeal", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"safedeal", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"safedeal", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"safedeal", "checkbudgets", &checkbudgets, true, true, false},
        {"safedeal", "mnsync", &mnsync, true, true, false},
        {"safedeal", "spork", &spork, true, true, false},
...
{
    return "> safedeal-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:21002/\n";
}
