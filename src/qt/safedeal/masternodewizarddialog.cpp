...
#include "qt/safedeal/forms/ui_masternodewizarddialog.h"

#include "activemasternode.h"
#include "optionsmodel.h"
#include "pairresult.h"
#include "qt/safedeal/mnmodel.h"
#include "qt/safedeal/guitransactionsutils.h"
    ...
    walletModel(model)
{
    ...
    if (walletModel->isRegTestNetwork()) {
        ui->lineEditPort->setText("21005");
    } else if (walletModel->isTestNetwork()) {
        ui->lineEditPort->setText("21003");
    } else {
        ui->lineEditPort->setText("21001");
    }
