...
#include "qt/safedeal/masternodeswidget.h"
#include "qt/safedeal/forms/ui_masternodeswidget.h"

#include "qt/safedeal/qtutils.h"
#include "qt/safedeal/mnrow.h"
#include "qt/safedeal/mninfodialog.h"
#include "qt/safedeal/masternodewizarddialog.h"
...
#include "util.h"
#include "qt/safedeal/optionbutton.h"
#include <iostream>
#include <fstream>
...
MasterNodesWidget::MasterNodesWidget(SafeDealGUI *parent) :
    PWidget(parent),
    ...
    if (fs::exists(pathBootstrap)) {
        ...
        if (lineCopy.size() == 0) {
            lineCopy = "# Masternode config file\n"
                                    ...
                                    "# Example: mn1 127.0.0.2:21001 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0\n";
        }
...
void MasterNodesWidget::onCreateMNClicked()
{
    ...
    if (walletModel->getBalance() <= GetMNCollateral() * COIN) {
        inform(tr("Not enough balance to create a masternode, %1 SFD required.").arg(GetMNCollateral()));
        return;
    }
    showHideOp(true);
