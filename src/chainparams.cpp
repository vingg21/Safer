...
public:
    CMainParams()
    {
        ...
        genesis.hashGenesisBlock = genesis.GetHash();
        assert(genesis.hashGenesisBlock == uint256S("0x0000056e5fd0bab4135edd0aab450b208d22842502b8cf12914c710033817f70"));
        ...
        consensus.nMaxMoneyOut = 10'000'000 * COIN;
        consensus.nPoolMaxTransactions = 3;
        consensus.nProposalEstablishmentTime = 60 * 60 * 24;    // must be at least a day old to make it into a budget
        consensus.nStakeMinAge = 60 * 120;
        ...
        consensus.nTime_EnforceNewSporkKey = 1611238802;    //!> Monday, 29 June 2020 10:00:00 AM GMT
        consensus.nTime_RejectOldSporkKey = 1611238802;     //!> Tuesday, 30 June 2020 12:00:00 AM GMT

        // height-based activations
        consensus.height_last_PoW = 370;
        consensus.height_start_BIP65 = 570;
        consensus.height_start_MessSignaturesV2 = 470;  // height_start_TimeProtoV2
        consensus.height_start_StakeModifierNewSelection = 1;
        consensus.height_start_StakeModifierV2 = 370;
        consensus.height_start_TimeProtoV2 = 470;
        ...
        base58Prefixes[EXT_COIN_TYPE] = boost::assign::list_of(0x80)(0x00)(0x00)(0x71).convert_to_container<std::vector<unsigned char> >();
...
public:
    CTestNetParams()
    {
        ...
        genesis = CreateGenesisBlock(1611238802, 499337, 0x1e0ffff0, 1, 250 * COIN);
        ...
        consensus.nTime_EnforceNewSporkKey = 1611238802;    //!> August 26, 2019 11:00:00 PM GMT
        consensus.nTime_RejectOldSporkKey = 1611238802;     //!> September 26, 2019 11:00:00 PM GMT
...
public:
    CRegTestParams()
    {
        ...
        */
        consensus.strSporkPubKey = "047ff78a093ca911fbe3c7cd9b8b81976696d92e6ad3d987b00a4cc4841fe9689ed6902be9c6942ef77492d0531bf68cf2e53dc0ac683359f938a7a52a988ced8c";
